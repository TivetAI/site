...
import imgLogo from "@/images/tivet-logos/icon-white.svg";
import {
	Icon,
	faBluesky,
	faDiscord,
...
const footer = {
	...
	company: [
		// { name: 'We\'re hiring!', href: 'https://tivet-gg.notion.site/Job-Board-eed66f2eab2b4d7ea3e21ccd63b22efe?pvs=4', newTab: true, highlight: true, badge: '1' },
		{ name: "Support", href: "/support" },
		{ name: "Pricing", href: "/pricing" },
		{ name: "Sales", href: "/sales" },
		{ name: "Status Page", href: "https://tivet.betteruptime.com/" },
		{ name: "OSS Friends", href: "/oss-friends" },
		{ name: "Press Kit", href: "https://releases.tivet.gg/press-kit.zip" },
	],
	legal: [
	...
	social: [
		...
		{
			name: "Twitter",
			href: "https://twitter.com/tivet_gg",
			icon: faTwitter,
		},
		{
			name: "Bluesky",
		...
		{
			name: "YouTube",
			href: "https://www.youtube.com/@tivet-gg",
			icon: faYoutube,
		},
		{
			name: "LinkedIn",
		...
		<div className="mx-auto max-w-screen-2xl pb-8 pt-16 sm:pt-20">
			<div className="xl:grid xl:grid-cols-2 xl:gap-8">
				...
				<div className="space-y-8">
					{/* Logo */}
					<Image className="size-12" src={imgLogo} alt="Tivet" />
			...
			<div className="mt-4 border-t border-white/10 pt-4 text-center md:mt-8">
				<p className="text-xs leading-5 text-white">
					&copy; {new Date().getFullYear()} Tivet Gaming, Inc. All
					rights reserved.
				</p>
			</div>
		</div>
