		...
		>
			<MainFeatureColumn
				...
				description={
					<>
						Autoscaling &{" "}
						<Tooltip tip="Boot servers on-demand in less than 5 seconds">
							instant servers
						</Tooltip>
						. Includes DDoS mitigation, monitoring, & crash
						reporting. Supports TCP, UDP, WebSockets, &{" "}
			...
			<MainFeatureColumn
				...
				description={
					<>
						...
						Authenticate with email, username, or{" "}
						<Tooltip tip="Google, Twitch, Discord, and more">
							social
						</Tooltip>
						.
					</>
			...
			<MainFeatureColumn
				...
				description={
					<>
						Pick and choose modules to use. Easily write server-side
						scripts & real-time actors.{" "}
						<Tooltip tip="Powered by Postgres">Database</Tooltip>{" "}
						included for free.
					</>
				}
				buttons={[
			...
			<div className="flex h-full items-start space-x-4">
				...
				<div className="flex h-full flex-grow flex-col">
					...
					<div className="mt-2 max-w-2xl">
						<p className="text-sm font-semibold text-cream-100/90">
							{description}
						</p>
					</div>
