...
export function LearnHome({ engineId, engineName, tutorials }) {
	...
	return (
		<>
			...
			<ResourceGroup title="Tivet Modules" columns={2}>
				<Resource
					title="Modules Overview"
					icon={faPuzzle}
					href={`${prefix}/general/modules`}
				>
					{`Use Tivet Modules to add game features.`}
				</Resource>
				<Resource
					title="Matchmaking & Lobbies"
					icon={faChess}
					href={`${prefix}/general/modules/categories/matchmaking`}
				>
          ...
          {`Implement party systems in your game.`}
				...
				<Resource
					...
					icon={faKey}
					href={`${prefix}/general/modules/categories/authentication`}
				>
					{`Add secure authentication to your game.`}
				</Resource>
				<Resource
					title="Friends, Groups, & Chat"
					icon={faShareNodes}
					href={`${prefix}/general/modules/categories/social`}
				>
        ...
        <Resource title="Economy" icon={faCoinFront} href={`${prefix}/general/modules/categories/economy`}>
          {`Implement in-game economy systems.`}
				...
				<Resource
					title="Storage"
					icon={faFloppyDisk}
					href={`${prefix}/general/modules/categories/storage`}
				>
			...
			<ResourceGroup title="Developing Modules" columns={2}>
				<Resource
					title="Developing Modules Overview"
					icon={faScrewdriverWrench}
					href={`/docs/${engineId}/modules/build`}
				>
				...
				<Resource
					title="Scripts"
					icon={faFileCode}
					href={`${prefix}/general/modules/build/scripts`}
				>
				...
				<Resource
					title="Database"
					icon={faDatabase}
					href={`${prefix}/general/modules/build/database`}
				>
				...
				<Resource
					title="Actors"
					icon={faBolt}
					href={`${prefix}/general/modules/build/actors`}
				>
				...
				<Resource
					...
					icon={faToolbox}
					href={`${prefix}/general/modules/build/utility-modules`}
				>
			...
			<ResourceGroup title="Advanced" columns={2}>
				<Resource
					...
					icon={faServer}
					href={`/docs/${engineId}/general/dynamic-servers`}
				>
				...
				<Resource
					title="Cloud"
					icon={faBooks}
					href={`/docs/${engineId}/general/cloud`}
				>
