...
//	- Curious about the technology -> Build with Tivet
		...
		sidebar: [
			{ title: "Overview", href: "/docs", icon: faSquareInfo },
			{
				...
				pages: [
					...
					{
						title: "Actor SDK",
						href: "https://www.npmjs.com/package/@tivet-gg/actor",
						icon: faActorsBorderless,
						external: true,
					},
					// {
					//   title: 'JavaScript SDK',
					//   href: 'https://jsr.io/@tivet-gg/actor-client',
					//   icon: 'js'
					// },
				],
			},
			{
				...
				pages: [
					{
						title: "TypeScript",
						href: "https://www.npmjs.com/package/@tivet-gg/actor-client",
						icon: faTs,
						external: true,
					},
					{
