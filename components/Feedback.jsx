...
import { faGithub } from "@tivet-gg/icons";
...
function EditButton() {
	const router = useRouter();
	const href = `https://github.com/tivet-gg/site/edit/main/src/pages${router.pathname}.mdx`;
...
const FeedbackForm = forwardRef(function FeedbackForm({ onSubmit }, ref) {
	return (
		...
		>
			{/* Left */}
			<p className="text-sm text-charcole-600 dark:text-cream-100">
