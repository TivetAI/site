...
import { TooltipProvider } from "@tivet-gg/components";
		...
		<>
			<Providers>
				<Head>
					...
					<meta property="og:url" content="https://tivet.gg/" />

					<meta name="twitter:card" content="summary_large_image" />
					<meta name="twitter:site" content="@tivet_gg" />
					<meta
						name="twitter:image"
					...
					<meta
						...
						content="Tivet - Run and scale realtime applications"
					/>
