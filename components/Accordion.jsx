"use client";
import { Icon, faCaretDown, faCaretRight } from "@tivet-gg/icons";
...
function getAccordionStyleFromVariant(variant) {
	if (variant === "minimalist") {
		...
		return {
			...
			contentClass:
				"mt-2 pt-1 mb-4 mx-[7px] px-4 border-l border-cream-100 dark:border-charcole-800",
		};
	}
	...
	return {
		parentClass:
			"border dark:border-charcole-800 rounded-xl mb-3 overflow-hidden",
		coverClass:
			"py-4 px-5 space-x-2 hover:bg-violet-100 hover:dark:bg-white/10 rounded-t-xl transition",
