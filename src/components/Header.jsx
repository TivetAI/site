...
import imgLogo from "@/images/tivet-logos/icon-cream.svg";
import imgLogoText from "@/images/tivet-logos/icon-text-cream.svg";
import {
	Icon,
	faCircle,
	faDiamond,
			...
			>
				...
				<div className="main-content-container flex h-14 w-full items-center justify-between gap-12 px-6 lg:z-30">
					...
					<div className="flex items-center gap-4">
						...
						{[
							[faDiscord, "/discord"],
							[faGithub, "https://github.com/tivet-gg/tivet"],
						].map(([icon, href]) => (
							<Link
