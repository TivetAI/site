...
| Topic                                  | Cloudflare Durable Objects                                                                             | Tivet                                                                                                                                                                      |
| -------------------------------------- | ------------------------------------------------------------------------------------------------------ | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
...
| Metadata                               | Have to build a weird hack to inform DO about its metadata                                             | See [Metadata docs](https://tivet.gg/docs/metadata)                                                                                                                        |
| Local dev & prod differences           | Wrangler frequently doesn't match prod                                                                 | When running local dev, you get a full Tivet cluster which is 1:1 the same behavior                                                                                        |
...
| Upgrading DO                           | Rolling out a session affinity system, TBD on effectiveness                                            | Full control over when to upgrade actors, see [actor.upgrade](https://tivet.gg/docs/api/actor/upgrade) and [actor.upgradeAll](https://tivet.gg/docs/api/actor/upgrade-all) |
